...
summ_b = function(data){
  
  
  out_all = 
      cbind(
      `Overall` = paste0(round(sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data)*100,2), "(",round(sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data) + c(-qnorm(0.975))*sqrt((1/nrow(Data))*sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data)*(1-sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data))),4)*100, "-", round(sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data) + c(qnorm(0.975))*sqrt((1/nrow(Data))*sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data)*(1-sum(data$psq_binary == 1 | data$psq_binary == 0, na.rm = T)/nrow(Data))),4)*100,")")
    )%>%
    cbind(
      ...
      bmi =paste0(median(data$bmi, na.rm = T), "(", unname(quantile(data$bmi, 0.25, na.rm = T)), "-", unname(quantile(data$bmi, 0.75, na.rm = T)), ")"),
      Age = paste0(median(data$age, na.rm = T), "(", unname(quantile(data$age, 0.25, na.rm = T)), "-", unname(quantile(data$age, 0.75, na.rm = T)), ")"),
  ...
  # return(out_all)
  assign(paste('out_base_', deparse(substitute(data)), sep = ""), out_all, envir = .GlobalEnv)
  
}

# endline

summ_e = function(data){
  ...
  out_all = 
    cbind(
      ...
      out_all = out_all %>%
        gather(key = "Characteristics", value = "All Participants\n")
      # return(out_all)
      assign(paste('out_end_', deparse(substitute(data)), sep = ""), out_all, envir = .GlobalEnv)
...
names(out_base_data_sdb) = c("Characteristics", "PSQ > 0.33")
...
names(out_base_data_no_sdb) = c("Characteristics", "PSQ < 0.33")
...
prop_baseline_sdb = function(data){
  ...
  # return(out_all)
  assign(paste0('out_prop_b_',deparse(substitute(data))),  out_prop, envir = .GlobalEnv)
  
}

# prop_baseline(data)
prop_baseline_sdb(data_sdb)

prop_baseline_no_sdb = function(data){
  
  # data = data_sdb
  
  out_prop = cbind(
    `Overall` = paste0(round(sum(data$psq_binary == 0 , na.rm = T)/nrow(Data)*100,2), "(",round(sum(data$psq_binary == 0 , na.rm = T)/nrow(Data) + c(-qnorm(0.975))*sqrt((1/nrow(Data))*sum(data$psq_binary == 0 , na.rm = T)/nrow(Data)*(1-sum(data$psq_binary == 0 , na.rm = T)/nrow(Data))),4)*100, "-", round(sum(data$psq_binary == 0 , na.rm = T)/nrow(Data) + c(qnorm(0.975))*sqrt((1/nrow(Data))*sum(data$psq_binary == 0 , na.rm = T)/nrow(Data)*(1-sum(data$psq_binary == 0 , na.rm = T)/nrow(Data))),4)*100,")")
  )%>%
    cbind(
      Height =paste0(median(data$height, na.rm = T), "(", unname(quantile(data$height, 0.25, na.rm = T)), "-", unname(quantile(data$height, 0.75, na.rm = T)), ")"),
      bmi =paste0(median(data$bmi, na.rm = T), "(", unname(quantile(data$bmi, 0.25, na.rm = T)), "-", unname(quantile(data$bmi, 0.75, na.rm = T)), ")"),
      Age = paste0(median(data$age, na.rm = T), "(", unname(quantile(data$age, 0.25, na.rm = T)), "-", unname(quantile(data$age, 0.75, na.rm = T)), ")"),
      `\t2-5 yrs` = paste0(round(sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$age_cat == '2-5', na.rm = T)/nrow(data))),4)*100,")"),
      `\t6-10 yrs` =paste0(round(sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$age_cat == '6-10', na.rm = T)/nrow(data))),4)*100,")")
    ...
    cbind(
      `\tMale` = paste0(round(sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$sex==1, na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(`\tFemale`=
            paste0(round(sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$sex==0, na.rm = T)/nrow(data))),4)*100,")") 
    )%>% cbind(
      `Asthma` = NA_character_,
      `\tAsthma Yes` =  paste0(round(sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_diag == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tAsthma No` = paste0(round(sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_diag == 0, na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(
      `Allergic rhinitis` = NA_character_,
      `\tYes` = paste0(round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNo` = paste0(round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data))),4)*100,")")
      
      
    ) %>%
    cbind(
      `Birth weight category` = NA_character_,
      `\t<2.5 kgs` = paste0(round(sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\t>=2.5 kgs` = paste0(round(sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Hospital category` = NA_character_,
      `\tPrivate` =  paste0(round(sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$hospital =='private', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tPublic` = paste0(round(sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$hospital == 'public', na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `BMI category`= NA_character_,
      `\tUnderweight` = paste0(round(sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNormal` = paste0(round(sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Normal', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tOverweight` = paste0(round(sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat =='Overweight', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tObese` = paste0(round(sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$bmi_cat == 'Obese', na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `OSA` = NA_character_,
      
      `\tOSA Yes` = paste0(round(sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$osa_binary == 1, na.rm = T)/nrow(data))),4)*100,")"),
    ...
    cbind(
      `wet bed`= NA_character_,
      `\twet Yes` = paste0(round(sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\twet No` = paste0(round(sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 2, na.rm = T)/nrow(data))),4)*100,")")#,
      
      # `\twet dont know` = paste0(round(sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wet_bed== 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Employment = NA_character_,
      `\tEmployed` = paste0(round(sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tSelf employed` = paste0(round(sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 2, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tUnemployed` = paste0(round(sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$employment == 3, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Insurance = NA_character_,
      `\tEmployer` =  paste0(round(sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance == 2, na.rm = T)/nrow(data))),4)*100,")"),
      `\tNHIF` =  paste0(round(sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNone`= paste0(round(sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==3, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tOther` = paste0(round(sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$insuarance ==4, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Smoking = NA_character_,
      `\tsmoking Yes` = paste0(round(sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$smoking == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tsmoking No` = paste0(round(sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$smoking == 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `child asthma` = NA_character_,
      `\tchild_asthma Yes` = paste0(round(sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$child_asthma== 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tchild_asthma No` = paste0(round(sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$child_asthma== 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Wheezing = NA_character_,
      `\twheezing Yes` =  paste0(round(sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wheezing ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\twheezing No` = paste0(round(sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$wheezing ==0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Asthma treatment` = NA_character_,
      `\tasthma treat yes` = paste0(round(sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_treat =="yes", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tasthma treat no` = paste0(round(sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$asthma_treat =="no", na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Symptomatic rhinitis` = NA_character_,
      `\tsymptomatic rhinitis no` = paste0(round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tsymptomatic rhinitis yes` = paste0(round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(
      `Known allergic rhinitis` = NA_character_,
      `\tknown allergic rhinitis yes` = paste0(round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tknown allergic rhinitis no` = paste0(round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$allergic_rhinitis ==0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `intranasal steroids` = NA_character_,
      `\tintranasal steroids no` = paste0(round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tintranasal steroids yes` = paste0(round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data))),4)*100,")") 
    ) %>%
    cbind(
      antiacids = NA_character_,
      `\tantiacids no` = paste0(round(sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$antiacids==0, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tantiacids yes` = paste0(round(sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data)*(1-sum(data$psq_binary == 0  & data$antiacids==1, na.rm = T)/nrow(data))),4)*100,")")
    )
  
  
  out_prop = out_prop %>%
    gather(key = "Characteristics", value = "no SDB\nBaseline")
  # return(out_all)
  assign(paste0('out_prop_b_',deparse(substitute(data))),  out_prop, envir = .GlobalEnv)
  
}

prop_baseline_no_sdb(data_no_sdb)

out_prop_baseline = left_join(out_prop_b_data_sdb, out_prop_b_data_no_sdb)

prop_endline_sdb = function(data){
  ...
  out_prop = out_prop %>%
    gather(key = "Characteristics", value = "SDB\nendline")
  # return(out_all)
  assign(paste0('out_prop_e_',deparse(substitute(data))),  out_prop, envir = .GlobalEnv)
  
}
# prop_endline(data)
prop_endline_sdb(data_sdb)

prop_endline_no_sdb = function(data){
  ...
  out_prop = cbind(
    ...
    cbind(
      ...
      bmi =paste0(median(data$bmi, na.rm = T), "(", unname(quantile(data$bmi, 0.25, na.rm = T)), "-", unname(quantile(data$bmi, 0.75, na.rm = T)), ")"),
      Age = paste0(median(data$age, na.rm = T), "(", unname(quantile(data$age, 0.25, na.rm = T)), "-", unname(quantile(data$age, 0.75, na.rm = T)), ")"),
      `\t2-5 yrs` = paste0(round(sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$age_cat == '2-5', na.rm = T)/nrow(data))),4)*100,")"),
      `\t6-10 yrs` =paste0(round(sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$age_cat == '6-10', na.rm = T)/nrow(data))),4)*100,")")
    ...
    cbind(
      `\tMale` = paste0(round(sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$sex==1, na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(`\tFemale`=
            paste0(round(sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$sex==0, na.rm = T)/nrow(data))),4)*100,")") 
    )%>% cbind(
      `Asthma` = NA_character_,
      `\tAsthma Yes` =  paste0(round(sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_diag == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tAsthma No` = paste0(round(sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_diag == 0, na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(
      `Allergic rhinitis` = NA_character_,
      `\tYes` = paste0(round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNo` = paste0(round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis_diag == 0, na.rm = T)/nrow(data))),4)*100,")")
      
      
    ) %>%
    cbind(
      `Birth weight category` = NA_character_,
      `\t<2.5 kgs` = paste0(round(sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$`birth weight` == "< 2.5 kgs", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\t>=2.5 kgs` = paste0(round(sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$`birth weight` == ">= 2.5 kgs", na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Hospital category` = NA_character_,
      `\tPrivate` =  paste0(round(sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$hospital =='private', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tPublic` = paste0(round(sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$hospital == 'public', na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `BMI category`= NA_character_,
      `\tUnderweight` = paste0(round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Underweightt', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNormal` = paste0(round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Normal', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tOverweight` = paste0(round(sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat =='Overweight', na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tObese` = paste0(round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$bmi_cat == 'Obese', na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `OSA` = NA_character_,
      
      `\tOSA Yes` = paste0(round(sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$osa_binary == 1, na.rm = T)/nrow(data))),4)*100,")"),
    ...
    cbind(
      `wet bed`= NA_character_,
      `\twet Yes` = paste0(round(sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\twet No` = paste0(round(sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 2, na.rm = T)/nrow(data))),4)*100,")")#,
      
      # `\twet dont know` = paste0(round(sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wet_bed== 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Employment = NA_character_,
      `\tEmployed` = paste0(round(sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tSelf employed` = paste0(round(sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 2, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tUnemployed` = paste0(round(sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$employment == 3, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Insurance = NA_character_,
      `\tEmployer` =  paste0(round(sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance == 2, na.rm = T)/nrow(data))),4)*100,")"),
      `\tNHIF` =  paste0(round(sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tNone`= paste0(round(sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==3, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tOther` = paste0(round(sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$insuarance ==4, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Smoking = NA_character_,
      `\tsmoking Yes` = paste0(round(sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$smoking == 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tsmoking No` = paste0(round(sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$smoking == 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `child asthma` = NA_character_,
      `\tchild_asthma Yes` = paste0(round(sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$child_asthma== 1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tchild_asthma No` = paste0(round(sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$child_asthma== 0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      Wheezing = NA_character_,
      `\twheezing Yes` =  paste0(round(sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wheezing ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\twheezing No` = paste0(round(sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$wheezing ==0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Asthma treatment` = NA_character_,
      `\tasthma treat yes` = paste0(round(sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_treat =="yes", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tasthma treat no` = paste0(round(sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$asthma_treat =="no", na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `Symptomatic rhinitis` = NA_character_,
      `\tsymptomatic rhinitis no` = paste0(round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="no", na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tsymptomatic rhinitis yes` = paste0(round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$rhiniti_symptomatic =="yes", na.rm = T)/nrow(data))),4)*100,")")
      
    ) %>%
    cbind(
      `Known allergic rhinitis` = NA_character_,
      `\tknown allergic rhinitis yes` = paste0(round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==1, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tknown allergic rhinitis no` = paste0(round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$allergic_rhinitis ==0, na.rm = T)/nrow(data))),4)*100,")")
    ) %>%
    cbind(
      `intranasal steroids` = NA_character_,
      `\tintranasal steroids no` = paste0(round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==0, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tintranasal steroids yes` = paste0(round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$steroid_nasal_spray ==1, na.rm = T)/nrow(data))),4)*100,")") 
    ) %>%
    cbind(
      antiacids = NA_character_,
      `\tantiacids no` = paste0(round(sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$antiacids==0, na.rm = T)/nrow(data))),4)*100,")"),
      
      `\tantiacids yes` = paste0(round(sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data)*100,2), "(",round(sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data) + c(-qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data))),4)*100, "-", round(sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data) + c(qnorm(0.975))*sqrt((1/nrow(data))*sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data)*(1-sum(data$psq_b_binary == 0 & data$antiacids==1, na.rm = T)/nrow(data))),4)*100,")")
    )
...
prop_endline_no_sdb(data_no_sdb)
out_prop_endline = left_join(out_prop_e_data_sdb, out_prop_e_data_no_sdb)
...
test_sdb = function(data, data_1){
  ...
  sexx = gather(sex, key, value, -sex)
  chi_sex =  tryCatch(stats::chisq.test( xtabs(value ~ key + sex, data = sexx)), error = function(e) NA)
  f_sex = tryCatch(stats::fisher.test(xtabs(value ~ key + sex, data = sexx)), error = function(e) NA)
  # f_sex$conf.int[1] # lower
  # f_sex$conf.int[2] #upper
  ...
  chi_asthma = tryCatch(chisq.test(xtabs(value ~ key + asthma_diag, data = asthma)), error = function(e) NA)
  f_asthma = tryCatch(stats::fisher.test(xtabs(value ~ key + asthma_diag, data = asthma)), error = function(e) NA)
  ...
  chi_employment = tryCatch(chisq.test(xtabs(value ~ key + employment, data = employment)), error = function(e) NA)
  f_employment = tryCatch(stats::fisher.test(xtabs(value ~ key + employment, data = employment)), error = function(e) NA)
  ...
  chi_insurance = tryCatch(chisq.test(xtabs(value ~ key + insuarance, data = insurance)), error = function(e) NA)
  f_insurance = tryCatch(stats::fisher.test(xtabs(value ~ key + insuarance, data = insurance)), error = function(e) NA)
  ...
  chi_smoking = tryCatch(chisq.test(xtabs(value ~ key + smoking, data = smoking)), error = function(e) NA)
  f_smoking = tryCatch(stats::fisher.test(xtabs(value ~ key + smoking, data = smoking)), error = function(e) NA)
  ...
  chi_child_asthma = tryCatch(chisq.test(xtabs(value ~ key + child_asthma, data = child_asthma)), error = function(e) NA)
  f_child_asthma = tryCatch(stats::fisher.test(xtabs(value ~ key + child_asthma, data = child_asthma)), error = function(e) NA)
  ...
  chi_wheezing = tryCatch(chisq.test(xtabs(value ~ key + wheezing, data = wheezing)), error = function(e) NA)
  f_wheezing = tryCatch(stats::fisher.test(xtabs(value ~ key + wheezing, data = wheezing)), error = function(e) NA)
  ...
  chi_asthma_treat = tryCatch(chisq.test(xtabs(value ~ key + asthma_treat, data = asthma_treat)), error = function(e) NA)
  f_asthma_treat = tryCatch(stats::fisher.test(xtabs(value ~ key + asthma_treat, data = asthma_treat)), error = function(e) NA)
  ...
  chi_rhiniti_symptomatic = tryCatch(chisq.test(xtabs(value ~ key + rhiniti_symptomatic, data = rhiniti_symptomatic)), error = function(e) NA)
  f_rhiniti_symptomatic = tryCatch(stats::fisher.test(xtabs(value ~ key + rhiniti_symptomatic, data = rhiniti_symptomatic)), error = function(e) NA)
  ...
  chi_allergic_rhinitis = tryCatch(chisq.test(xtabs(value ~ key + allergic_rhinitis, data = allergic_rhinitis)), error = function(e) NA)
  f_allergic_rhinitis = tryCatch(stats::fisher.test(xtabs(value ~ key + allergic_rhinitis, data = allergic_rhinitis)), error = function(e) NA)
  ...
  chi_antiacids = tryCatch(chisq.test(xtabs(value ~ key + antiacids, data = antiacids)), error = function(e) NA)
  f_antiacids = tryCatch(stats::fisher.test(xtabs(value ~ key + antiacids, data = antiacids)), error = function(e) NA)
  ...
  chi_steroid_nasal_spray = tryCatch(chisq.test(xtabs(value ~ key + steroid_nasal_spray, data = steroid_nasal_spray)), error = function(e) NA)
  f_steroid_nasal_spray = tryCatch(stats::fisher.test(xtabs(value ~ key + steroid_nasal_spray, data = steroid_nasal_spray)), error = function(e) NA)
  ...
  chi_rhinitis = tryCatch(chisq.test(xtabs(value ~ key + allergic_rhinitis_diag, data = rhinitis)), error = function(e) NA)
  f_rhinitis = tryCatch(stats::fisher.test(xtabs(value ~ key + allergic_rhinitis_diag, data = rhinitis)), error = function(e) NA)
  ...
  chi_bmi_cat = tryCatch(chisq.test(xtabs(value ~ key + bmi_cat, data = bmi_cat)), error = function(e) NA)
  f_bmi_cat = tryCatch(stats::fisher.test(xtabs(value ~ key + bmi_cat, data = bmi_cat)), error = function(e) NA)
  ...
  chi_birth_weight = tryCatch(chisq.test(xtabs(value ~ key + `birth weight`, data = birth_weight)), error = function(e) NA)
  f_birth_weight = tryCatch(stats::fisher.test(xtabs(value ~ key + `birth weight`, data = birth_weight)), error = function(e) NA)
  ...
  chi_hospital = tryCatch(chisq.test(xtabs(value ~ key + hospital, data = hospital)), error = function(e) NA)
  f_hospital = tryCatch(stats::fisher.test(xtabs(value ~ key + hospital, data = hospital)), error = function(e) NA)
  
  
  # height
  
  height_t = tryCatch(t.test(data$height, data_1$height), error = function(e) NA)
  height_w = tryCatch(wilcox.test(data$height, data_1$height, conf.int = T), error = function(e) NA)
  ...
  chi_osa = tryCatch(chisq.test(xtabs(value ~ key + osa_binary, data = osa)), error = function(e) NA)
  f_osa = tryCatch(stats::fisher.test(xtabs(value ~ key + osa_binary, data = osa)), error = function(e) NA)
  ...
  chi_wet_cat = tryCatch(chisq.test(xtabs(value ~ key + wet_bed, data = wet_cat)), error = function(e) NA)
  f_wet_cat = tryCatch(stats::fisher.test(xtabs(value ~ key + wet_bed, data = wet_cat)), error = function(e) NA)
  
  p_val_sdb = cbind(
    `Gender` = tryCatch(round(f_sex$p.value,3), error = function(e) NA),
    `Age` = tryCatch(round(age_w$p.value,3), error = function(e) NA),
    `Asthma` = tryCatch(round(f_asthma$p.value,3), error = function(e) NA),
    `Allergic rhinitis` = tryCatch(round(chi_rhinitis$p.value,3), error = function(e) NA),
    `BMI category` = tryCatch(round(f_bmi_cat$p.value,3), error = function(e) NA),
    `Birth weight category` = tryCatch(round(f_birth_weight$p.value,3), error = function(e) NA),
    `Hospital category` = tryCatch(round(f_hospital$p.value,3), error = function(e) NA), 
    `OSA` = tryCatch(round(f_osa$p.value,3), error = function(e) NA),
    `wet bed` = tryCatch(round(f_wet_cat$p.value,3), error = function(e) NA),
    `Employment` = tryCatch(round(f_employment$p.value,3), error = function(e) NA),
    `Insurance` = tryCatch(round(f_insurance$p.value,3), error = function(e) NA),
    `Smoking` = tryCatch(round(f_smoking$p.value,3), error = function(e) NA),
    `child asthma` = tryCatch(round(f_child_asthma$p.value,3), error = function(e) NA),
    `Wheezing` = tryCatch(round(f_wheezing$p.value,3), error = function(e) NA),
    `Asthma treatment` = tryCatch(round(f_asthma_treat$p.value,3), error = function(e) NA),
    `Symptomatic rhinitis` = tryCatch(round(f_rhiniti_symptomatic$p.value,3), error = function(e) NA),
    `Known allergic rhinitis` = tryCatch(round(f_allergic_rhinitis$p.value,3), error = function(e) NA),
    `intranasal steroids` = tryCatch(round(f_steroid_nasal_spray$p.value,3), error = function(e) NA),
    `antiacids` = tryCatch(round(f_antiacids$p.value,3), error = function(e) NA)
  )
  ...
  conf_sdb = cbind(
    `Gender` = tryCatch(paste(round(as.numeric(f_sex$conf.int[1]),4),round(as.numeric(f_sex$conf.int[2]),4), sep = ","), error = function(e) NA),
    `Age` = tryCatch(paste(round(as.numeric(age_w$conf.int[1]),4),round(as.numeric(age_w$conf.int[2]),4), sep = ","), error = function(e) NA),
    `Asthma` = tryCatch(paste(round(as.numeric(f_asthma$conf.int[1]),4),round(as.numeric(f_asthma$conf.int[2]),4), sep = ","), error = function(e) NA), #f_asthma
    `Allergic rhinitis` = tryCatch(paste(round(as.numeric(f_rhinitis$conf.int[1]),4),round(as.numeric(f_rhinitis$conf.int[2]),4), sep = ","), error = function(e) NA), #f_rhinitis
    `BMI category` = tryCatch(paste(round(as.numeric(f_bmi_cat$conf.int[1]),4),round(as.numeric(f_bmi_cat$conf.int[2]),4), sep = ","), error = function(e) NA), #f_bmi_cat
    `Birth weight category` = tryCatch(paste(round(as.numeric(f_birth_weight$conf.int[1]),4),round(as.numeric(f_birth_weight$conf.int[2]),4), sep = ","), error = function(e) NA), #f_birth_weight
    `Hospital category` = tryCatch(paste(round(as.numeric(f_hospital$conf.int[1]),4),round(as.numeric(f_hospital$conf.int[2])), sep = ","), error = function(e) NA), #f_hospital
    `OSA` = tryCatch(paste(round(as.numeric(f_osa$conf.int[1]),4),round(as.numeric(f_osa$conf.int[2]),4), sep = ","), error = function(e) NA),
    `wet bed` = tryCatch(paste(round(as.numeric(f_wet_cat$conf.int[1]),4),round(as.numeric(f_wet_cat$conf.int[2]),4), sep = ","), error = function(e) NA),
    `Employment` = tryCatch(paste(round(as.numeric(f_employment$conf.int[1]),4),round(as.numeric(f_employment$conf.int[2]),4), sep = ","), error = function(e) NA),
    `Insurance` = tryCatch(paste(round(as.numeric(f_insurance$conf.int[1]),4),round(as.numeric(f_insurance$conf.int[2]),4), sep = ","), error = function(e) NA),
    `Smoking` = tryCatch(paste(round(as.numeric(f_smoking$conf.int[1]),4),round(as.numeric(f_smoking$conf.int[2]),4), sep = ","), error = function(e) NA), #f_asthma
    `child asthma` = tryCatch(paste(round(as.numeric(f_child_asthma$conf.int[1]),4),round(as.numeric(f_child_asthma$conf.int[2]),4), sep = ","), error = function(e) NA), #f_rhinitis
    `Wheezing` = tryCatch(paste(round(as.numeric(f_wheezing$conf.int[1]),4),round(as.numeric(f_wheezing$conf.int[2]),4), sep = ","), error = function(e) NA), #f_bmi_cat
    `Asthma treatment` = tryCatch(paste(round(as.numeric(f_asthma_treat$conf.int[1]),4),round(as.numeric(f_asthma_treat$conf.int[2]),4), sep = ","), error = function(e) NA), #f_birth_weight
    `Symptomatic rhinitis` = tryCatch(paste(round(as.numeric(f_rhiniti_symptomatic$conf.int[1]),4),round(as.numeric(f_rhiniti_symptomatic$conf.int[2])), sep = ","), error = function(e) NA), #f_hospital
    `Known allergic rhinitis` = tryCatch(paste(round(as.numeric(f_allergic_rhinitis$conf.int[1]),4),round(as.numeric(f_allergic_rhinitis$conf.int[2]),4), sep = ","), error = function(e) NA),
    `intranasal steroids` = tryCatch(paste(round(as.numeric(f_steroid_nasal_spray$conf.int[1]),4),round(as.numeric(f_steroid_nasal_spray$conf.int[2]),4), sep = ","), error = function(e) NA),
    `antiacids` = tryCatch(paste(round(as.numeric(f_antiacids$conf.int[1]),4),round(as.numeric(f_antiacids$conf.int[2]),4), sep = ","), error = function(e) NA)
  )
  
  conf_sdb = as_tibble(conf_sdb) %>%
    # mutate_all(., as.numeric) %>%
    gather(., key = "Characteristics", value = "CI")
  assign(paste0("conf_",deparse(substitute(data))), conf_sdb, envir = .GlobalEnv)
  assign(paste0("p_val_",deparse(substitute(data))),  p_val_sdb, envir = .GlobalEnv)
}
...
test_sdb(data_sdb, data_no_sdb)
test_sdb(data_sdb_end, data_no_sdb_end)

names(conf_data_sdb) = c("Characteristics", "baseline\n CI")
names(conf_data_sdb_end) = c("Characteristics", "endline\n CI")
names(p_val_data_sdb) = c("Characteristics", "baseline\n p-value")
names(p_val_data_sdb_end) = c("Characteristics", "endline\n p-value")

prop_out = out_prop_baseline %>%
  left_join(., p_val_data_sdb) %>%
  left_join(., conf_data_sdb) %>%
  left_join(., out_prop_endline) %>%
