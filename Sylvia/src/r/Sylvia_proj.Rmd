...
train_x <- model.matrix(psq_b_binary ~allergic_rhinitis_diag+asthma_diag+height+`birth weight`+age_cat+sex+bmi+wet_bed, data)[,-1]
...
psq_gee2 <- gee(psq_b_binary ~ allergic_rhinitis_diag+asthma_diag+height+`birth weight`+age_cat+sex+bmi+wet_bed, data = data, family = "binomial", id = sub_id, corstr = "exchangeable", scale.fix = TRUE,scale.value = 1)
