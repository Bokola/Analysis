...
## ---- include=FALSE, echo=F, warning=F, message=F, error=F-----------------------------------
...
## ----time4_hist,results='hide', eval=FALSE---------------------------------------------------
## data_factor %>%
...
## ----box_plot, results='hide',eval=FALSE-----------------------------------------------------
...
## ----linearity, fig.cap="Scatter plot of log(time4) against age", eval=FALSE-----------------
...
## ---- fig.cap='Data points by year of biopsy sample collection'------------------------------
...
## --------------------------------------------------------------------------------------------
knitr::kable(time_iqr, caption = "Median ToT in days by year of biopsy sample collection \\label{tab:median_time}",
             format = "pandoc")
