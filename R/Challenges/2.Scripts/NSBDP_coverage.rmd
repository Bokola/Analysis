...
list.of.pkgs<-c("foreign","dplyr","corrr","ggplot2","plotly", "tidyr","readstata13","magrittr","RCurl","haven")
ipk(list.of.pkgs)
...
## Exploration
```{r}
ggplot(dat,aes(coverage))+geom_histogram(aes(y=..density..))+geom_density()
#Scatter
scatter_by<- function(data,...) {
  ggplot(data)+geom_point(aes(...))
}
scatter_by(dat,factor(sensitize_method),coverage,shape=sensitize_method) +scale_x_discrete(labels=c("1","2","3","4","5","6"))
